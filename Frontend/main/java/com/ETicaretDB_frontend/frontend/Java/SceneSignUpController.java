...
public class SceneSignUpController {
    ...
    {
        try {
            if(Log.trySignUp(usernameSignUpField.getText(), passwordSignUpField.getText(), passwordSignUpField2.getText(), emailSignUpField.getText()))
            {
    ...
    public void switchToSceneSignIn(Event e) //switches to signIn scene
    {
        ...
        {
            Parent root = FXMLLoader.load(getClass().getResource("/com/ETicaretDB_frontend/frontend/Views/SceneSignIn-Primary.fxml")); //get fxml contens
    ...
    {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/com/ETicaretDB_frontend/frontend/Views/SceneSignUpSuccesfullAlert.fxml")); //get fxml contents
            ...
            System.out.println("/com/ETicaretDB_frontend/frontend/Views/SceneSignUpSuccesfullAlert.fxml could not be loaded");
        }
    }
}
